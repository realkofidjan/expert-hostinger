...
import {
  ...
  Truck, ShieldCheck, Star, Share2,
  LayoutGrid, FileText, MessageSquare, BadgeCheck
} from 'lucide-react';
...
const ProductDetail = () => {
  ...
  const tabs = [
    ...
    { id: 'shipping', label: 'Delivery & Returns', icon: <Truck className="w-4 h-4" /> },
  ];
      ...
      <main className="pt-32 pb-20 px-4 md:px-6 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20">
                ...
                <div className="flex gap-6 overflow-x-auto py-4 scrollbar-hide snap-x" id="thumbnail-carousel">
                  {images.map((img, idx) => (
                    <button
                      ...
                      className={`flex-shrink-0 w-28 h-28 rounded-2xl overflow-hidden border-2 transition-all duration-500 snap-start p-1 bg-white dark:bg-gray-800 shadow-lg ${activeImage === idx
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm font-bold text-green-600 uppercase tracking-widest mb-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {product.variants.map((v) => (
                    <button
                      ...
                      className={`px-4 py-2.5 rounded-xl border-2 transition-all flex items-center gap-3 ${selectedVariant?.id === v.id
          ...
          <div className="flex border-b border-gray-100 dark:border-gray-800 mb-12">
            {tabs.map(tab => (
              <button
                ...
                className={`flex items-center gap-2 px-6 py-4 text-xs font-black uppercase tracking-widest relative ${activeTab === tab.id ? 'text-green-600' : 'text-gray-400'
                  }`}
              >
                {tab.icon} {tab.label}
